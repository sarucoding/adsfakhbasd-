...
class Order extends Base {
    ...
    public function return_goods_info()
    {
        ...
        $delivery_doc= Db::name('delivery_doc')->where(['order_id'=>$return_goods['order_id']])->find();
        $store_address_province_id = $delivery_doc['store_address_province_id'];
        $store_address_city_id     = $delivery_doc['store_address_city_id'];
        $store_address_district_id = $delivery_doc['store_address_district_id'];
        $store['store_phone'] = $delivery_doc['store_address_mobile'];
        $store['store_name'] = $delivery_doc['store_address_consignee'];
        $region = Db::name('region')
            ->where("id in($store_address_province_id,$store_address_city_id,{$store_address_district_id})")
            ->getField('id,name');
        $store['store_address'] = $region["$store_address_province_id"].$region["$store_address_city_id"].$region["$store_address_district_id"].$delivery_doc['store_address'];
