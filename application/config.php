...
return [
    ...
    'cache'                  => [
        ...
        'path'   => CACHE_PATH,
        // 缓存前缀
        'prefix' => '605ab1ad2c8f6beeb4a17ece17a51cad',
        // 缓存有效期 0表示永久缓存
        'expire' => 0,
    ],
    /*
...
*/
	...
	'shipping_lists' => ['seller'=>'商家配送','third'=>'第三方配送','self'=>'门店自提'],
	'payment_lists' => ['alipay'=>'支付宝支付','weixin'=>'微信支付','balance'=>'余额支付','contract'=>'账期支付'],
	'orderNavArr' => [
		['全部','待付款','待发货','实发数','待付尾款','待收货','已完成'],
		['全部','待发货','实发数','待收货','待扎账','待付款','已付款'],
	],
];
