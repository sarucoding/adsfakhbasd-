...
class Goods extends Validate
{
    ...
    protected $rule = [
        ...
        'goods_name'           =>'require|max:150|unique:goods,goods_name^store_id',
    ...
    protected $message  = [
        ...
        'goods_unit.require'                            => '计量单位必填',
        'store_cat_id2.number'                          => '本店分类必须选择到二级',
        'store_cat_id2.gt'                              => '本店分类必须选择到第二级',
    ];
