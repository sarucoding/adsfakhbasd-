...
!function (window) {
    ...
    CitySelect.prototype.init = function () {
        ...
        _this.defaultSet = {
            ...
            provance_id: options.provance_id,
            city: options.city,
    ...
    CitySelect.prototype.bindItemEvent = function () {
        ...
        $cityElement.on('click.ydui.cityselect', '.cityselect-item-box a', function () {
            ...
            _this.setNavTxt(tag, $this.text(), $this.attr('data-id'));
            ...
            if (tag == 0) {
                ...
                defaultSet.provance_id = $nav.eq(0).attr('data-id');
                defaultSet.city = $nav.eq(1).html();
                defaultSet.city_id = $nav.eq(1).attr('data-id');
                defaultSet.area = $nav.eq(2).html();
                defaultSet.area_id = $nav.eq(2).attr('data-id');
    ...
    CitySelect.prototype.loadProvance = function () {
        ...
        $.each(_this.citys, function (k, v) {
            arr.push($('<a data-id="' + v.id + '" class="' + (v.id == _this.defaultSet.provance_id ? 'crt' : '') + '" href="javascript:;"><span>' + v.n + '</span></a>').data({
                citys: v.c,
                tag: 0
            }));
        });
    ...
    CitySelect.prototype.loadCity = function () {
        ...
        $.each(cityData, function (k, v) {
            arr.push($('<a data-id="' + v.id + '" class="' + (v.id == _this.defaultSet.city_id ? 'crt' : '') + '" href="javascript:;"><span>' + v.n + '</span></a>').data({
                citys: v.a,
                tag: 1
            }));
        });
    ...
    CitySelect.prototype.loadArea = function () {
        ...
        $.each(areaData, function (k, v) {
            arr.push($('<a data-id="' + v.id + '" class="' + (v.id == _this.defaultSet.area_id ? 'crt' : '') + '" href="javascript:;"><span>' + v.n + '</span></a>').data({tag: 2}));
        });
